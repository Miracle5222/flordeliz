        ...
        <div class="w-full max-w-md">
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-600">
                    Staff? <a href="/pages/login_staff.php" class="text-amber-600 hover:text-amber-700 font-semibold">Login here</a>
                </p>
                <p class="text-gray-600 mt-2">
                    <a href="/" class="text-amber-600 hover:text-amber-700 font-semibold">Back to home</a>
                </p>
            </div>
        </div>
    </div>
