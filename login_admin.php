...
<head>
    ...
    <title>Admin Login - Flor de Liz</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                <div class="w-16 h-16 bg-gradient-to-br from-amber-600 to-amber-800 rounded-xl flex items-center justify-center mx-auto mb-4">
                    <span class="text-white font-bold text-2xl">AD</span>
                </div>
                <h1 class="text-3xl font-bold text-gray-900">Admin Portal</h1>
                <p class="text-gray-600 mt-2">Sign in to manage operations</p>
            </div>

            <!-- Error Message -->
            <?php if(!empty($_GET['error'])) { ?>
                <div class="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                    <p class="text-red-600 text-sm font-medium">Invalid credentials. Please try again.</p>
                </div>
            <?php } ?>
            ...
            <form method="post" action="./config/auth.php" class="bg-white rounded-xl shadow-lg p-8">
                ...
                <div class="mb-6">
                    ...
                    <input 
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition"
                    >
                ...
                <button 
                    type="submit"
                    class="w-full py-2 bg-gradient-to-r from-amber-600 to-amber-700 text-white font-semibold rounded-lg hover:from-amber-700 hover:to-amber-800 transition shadow-lg"
                >
                    Sign In
                </button>
            </form>
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-600">
                    Staff? <a href="login_staff.php" class="text-amber-600 hover:text-amber-700 font-semibold">Login here</a>
                </p>
                <p class="text-gray-600 mt-2">
                    <a href="index.php" class="text-amber-600 hover:text-amber-700 font-semibold">Back to home</a>
                </p>
            </div>
        </div>
    </div>
