        ...
        <div class="w-full max-w-md">
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-600">
                    Admin? <a href="login_admin.php" class="text-teal-600 hover:text-teal-700 font-semibold">Login here</a>
                </p>
                <p class="text-gray-600 mt-2">
                    <a href="index.php" class="text-teal-600 hover:text-teal-700 font-semibold">Back to home</a>
                </p>
            </div>
        </div>
    </div>
